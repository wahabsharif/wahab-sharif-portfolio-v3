...
export default function TimeTracker(): JSX.Element {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            ...
            const elapsedTime = Math.floor((currentTime.getTime() - startDate.getTime()) / 1000); // Total elapsed seconds
    ...
    return (
        <section className="overflow-hidden px-6 py-32 sm:px-14 md:px-20">
            <div className="text-center">
                <h4 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-semibold mb-6">Duration Engaged in Coding</h4>
                <AnimatePresence>
                    <FadeRight
                        key="time-tracker"
                        duration={0.4}
                        ...
                        className="-z-20"
                    >
                        <div className="text-xl font-bold text-teal-600 dark:text-teal-300 flex flex-wrap justify-center gap-4">
