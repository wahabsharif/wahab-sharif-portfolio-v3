...
import { GithubIcon, Instagram, LinkedinIcon, WhatsAppIcon } from "@/components/Icons";
  ...
  return (
    <footer className="flex w-full flex-col items-center gap-20 bg-transparent px-6 py-8 sm:px-14 md:px-20">
      ...
      <div className="flex w-full flex-col items-center justify-between gap-8 text-center  md:flex-row md:justify-between lg:mx-auto lg:max-w-7xl">
        <span>©{currentYear} Wahab Sharif - Crafted with Passion and A Dash of Coffee</span>
        <div className="flex gap-8">
          ...
          >
            <WhatsAppIcon className="text-teal-600 transition-colors duration-150 hover:text-tera-500 dark:text-teal-400 dark:hover:text-white" />
          </a>
          <a
            ...
            aria-label="link to WhatsApp"
          >
            <Instagram className="text-teal-600 transition-colors duration-150 hover:text-tera-500 dark:text-teal-400 dark:hover:text-white" />
          </a>
          <a
